 ...
 while(scancode != ESC_BREAK){
   ...
   switch (movement){
    case XMOV_POS:
      ...
      vg_draw_rectangle(xi, yi, x-xi, img_height, 0);
      break;
    ...
    case YMOV_POS:
      ...
      vg_draw_rectangle(xi, yi, img_width, y-yi, 0);
      break;
    ...
    case XMOV_NEG:
      ...
      vg_draw_rectangle(x + img_width, y, xi-x, img_height, 0);
      break;
    ...
    case YMOV_NEG:
      ...
      vg_draw_rectangle(x, y + img_height, img_width, yi-y, 0);
      break;
